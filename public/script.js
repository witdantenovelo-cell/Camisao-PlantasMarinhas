// Troca a alga da semana automaticamente
const algas = [
  "Alga Estrela",
  "Alga Azul",
  "Alga Verde Esmeralda",
  "Alga Coralina",
  "Alga Solar"
];

// Número da semana baseado no timestamp
const index = Math.floor(
  (Date.now() / (1000 * 60 * 60 * 24 * 7)) % algas.length
);

document.querySelector('#alga-semana h3').textContent = algas[index];
